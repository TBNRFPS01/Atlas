...
from interface.theme import (
    ACCENT, BACKGROUND, BORDER, CHAT_MAX_WIDTH, FONT_FAMILY,
    FONT_SIZE_BASE, FONT_SIZE_SM, FONT_SIZE_XS, INK, INK_SOFT,
    MUTED,
)
...
class _Bubble(tk.Canvas):
    ...
    def __init__(self, parent: tk.Widget, text: str, max_width: int = 540) -> None:
        ...
        self._label = tk.Label(
            self, text=text, bg="#FFFDF8", fg=INK,
            font=(FONT_FAMILY, FONT_SIZE_BASE, "normal"),
            justify="left", anchor="nw", wraplength=max_width,
        )
    ...
    def _layout(self) -> None:
        ...
        self.create_window(
            self._padx, self._pady, window=self._label, anchor="nw",
...
class ChatView:
    ...
    def __init__(
        self, parent: tk.Widget, messages: list[ChatMessage], *,
        on_copy: Callable[[str], Any], on_edit: Callable[[str], Any],
        on_regenerate: Callable[[], Any], on_toast: Callable[[str], Any],
        ...
        self._thinking_row: tk.Frame | None = None
        self._build()
    ...
    def _on_canvas_configure(self, event: tk.Event) -> None:
        ...
        if not self._rows:
            ...
            # height=0 tells a canvas window item to use the child's requested height.
            self.canvas.itemconfigure(self._chat_window, height=0)
    ...
    def _build_welcome(self) -> None:
        ...
        tk.Label(
            stage, text="What are we building?", bg=BACKGROUND, fg=ACCENT,
        ...
        tk.Label(
            ...
            bg=BACKGROUND, fg=INK_SOFT,
            font=(FONT_FAMILY, FONT_SIZE_BASE + 1, "normal"), justify="center",
        ).pack(pady=(14, 30))
    ...
    def _suggestion_card(self, parent: tk.Widget, title: str, subtitle: str) -> tk.Frame:
        card = tk.Frame(
            parent, bg="#FFFDF8", width=280, height=88,
        ...
        title_label = tk.Label(
            inner, text=title, bg="#FFFDF8", fg=INK,
            font=(FONT_FAMILY, FONT_SIZE_BASE, "bold"), anchor="w",
        )
        title_label.pack(fill="x")
        subtitle_label = tk.Label(
            inner, text=subtitle, bg="#FFFDF8", fg=MUTED,
    ...
    def _render_assistant(self, message: ChatMessage) -> None:
        ...
        content = tk.Label(
            body, text=message.content, bg=BACKGROUND, fg=INK,
